          ...
          <>
            ...
            {feedback.length > 0 && (
              <section className="mt-6 overflow-hidden rounded-[28px] border border-[#cbdcd5] bg-[linear-gradient(145deg,#ffffff_0%,#fbfdfc_100%)] p-5 shadow-[0_14px_36px_rgba(40,90,75,0.055)] sm:p-6">
                ...
                <div className="relative mt-5 mb-0 overflow-hidden rounded-[26px] bg-[linear-gradient(135deg,#123a43_0%,#195563_55%,#247c78_100%)] px-5 py-5 pr-24 text-white shadow-[0_16px_34px_rgba(25,72,66,0.14),inset_0_1px_0_rgba(255,255,255,0.14)] sm:px-6 sm:py-6 sm:pr-28">
                  ...
                  <div className="relative flex items-center justify-between gap-4">
                    ...
                    <div className="pointer-events-none absolute right-4 top-4 z-10 h-16 w-16 overflow-hidden rounded-2xl border border-white/20 bg-white/10 shadow-[0_10px_24px_rgba(0,0,0,0.18),inset_0_1px_0_rgba(255,255,255,0.14)] backdrop-blur-sm sm:right-5 sm:top-5 sm:h-20 sm:w-20">
                      <video
