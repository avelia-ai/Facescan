      ...
      <div className="mx-auto flex min-h-[calc(100vh-4rem)] max-w-md flex-col">
        <div className="pt-4">
          ...
          <div className="h-1.5 overflow-hidden rounded-full bg-[#dfe8e9]">
            <div className="h-full w-[60%] rounded-full bg-[#168f91]" />
          </div>
        </div>
            ...
            return (
              <button
                ...
                className={`flex w-full items-center gap-4 rounded-[24px] border p-4 text-left transition ${
                  selected
                    ? "border-[#168f91] bg-[#e5faf7] shadow-sm"
                    : "border-[#dce7e8] bg-white hover:bg-[#f9fbfb]"
                }`}
              >
                <div
                ...
                <div
                  className={`flex h-6 w-6 shrink-0 items-center justify-center rounded-full border text-xs ${
                    selected
                      ...
                      : "border-[#cbd8da] bg-white text-transparent"
                  }`}
                >
                  ✓
                </div>
        ...
        {error && (
          <div className="mt-4 rounded-2xl bg-[#fff0eb] px-4 py-3 text-sm leading-5 text-[#a64f3d]">
            {error}
          </div>
        )}
